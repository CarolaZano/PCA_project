...
#! Name of the job:
#SBATCH -J Likelihood_GR_parallel_mpi_PCACuts_new
...
source /home/dc-zano2/venvs/PCA_env_copy/bin/activate

#! Full path to application executable: 
application="Likelihood_GR_parallel_mpi_PCACuts_new.py"
...
CMD="mpirun -ppn $mpi_tasks_per_node -np $np python3 $application $options"
