...
def log_likelihood(theta, Data, fsigma8_Data, invcovmat):
    Omega_c, mu0, A_s1e9, h, n_s, wb, b1, b2, b3, b4, b5 = theta 
...
def log_prior(theta):
    ...
    #flat priors
    if not (0.1 < Omega_c + wb/h**2 < 0.9 and 0 <= mu0 < 1.0 \
...
print("lp fid= ",log_probability([cosmo_universe["Omega_c"],0,cosmo_universe["A_s"]*1e9,cosmo_universe["h"],cosmo_universe["n_s"],\
...
print("lp max= ",log_probability([2.80767748e-01, 1.52992161e-01  , 2.11379353e+00,\
