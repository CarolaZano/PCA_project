...
def log_prior(theta):
    ...
    #flat priors
    if not (0.1 < Omega_c + wb/h**2 < 0.9 and 0 <= mu0 < 1.5 \
...
pos = [Omega_c_est, mu0_est, A_s1e9_est, h_est, n_s_est, wb_est, b1_est, b2_est, b3_est, b4_est, b5_est] + \
...
mcmc_dir = "mcmc"
filename = mcmc_dir + "/mcmc_fR_muSigma_StandardCuts.h5"
