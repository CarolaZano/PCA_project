...
#! Name of the job:
#SBATCH -J 	Likelihood_GR_parallel_mpi_StandardCuts_test
#! Which project should be charged:
#SBATCH -A DIRAC-DP350-CPU
#SBATCH -p cclake
...
source /home/dc-zano2/venvs/PCA_env/bin/activate

#! Full path to application executable: 
application="Likelihood_GR_parallel_mpi_StandardCuts_test.py"
...
CMD="mpirun -ppn $mpi_tasks_per_node -np $np python $application $options"
